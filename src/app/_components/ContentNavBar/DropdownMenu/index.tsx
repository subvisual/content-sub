...
const iconMap = {
  ...
  TalksAndRoundtables: <TalksIcon width={"16"} stroke={"black"} />,
};
...
export default function DropdownMenu({ activeButton, onActiveButtonChange }) {
  ...
  return (
    <div className={styles.dropdownContainer}>
      <svg width="" height="62" viewBox="0 0 277 62" fill="white" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 61L1 26C1 12.1929 12.1929 1 26 1L211.446 1C220.173 1 228.269 5.55102 232.804 13.007L254.696 48.993C259.231 56.449 267.327 61 276.054 61H276.5" stroke="black" />
      </svg>
      <button className={styles.dropdownButton} onClick={() => setIsDropdownActive(!isDropdownActive)}>
      ...
      {isDropdownActive && (
        <div className={styles.dropdownMenuContainer}>
          <div className={styles.dropdownMenu}>
            <ul>
              <li onClick={() => handleButtonClick("All")}>
                {iconMap["All"]} All
              </li>
