export function MagnifyingGlass ( { x, y }) {
  return (
     <svg x={x} y={y} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export function PodcastIcon ( { x, y }) {
  return (
     <svg x={x} y={y} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export function BlogpostIcon ( { x, y }) {
  return (
     <svg x={x} y={y} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export function CaseStudiesIcon ( { x, y }) {
  return (
     <svg x={x} y={y} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export function XIcon ( { x, y }) {
  return (
     <svg x={x} y={y} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M17 1L1 17M17 17L1 1" stroke="black" stroke-width="2" stroke-linecap="round" />
    </svg>
  )
}
...
export function MoveFifteenIcon ( { x, y }) {
  return (
     <svg x={x} y={y} width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export function BackFifteenIcon ( { x, y }) {
  return (
     <svg x={x} y={y} width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
export function AllIcon ( { x, y, width = "24", height = "24" }) {
  return (
