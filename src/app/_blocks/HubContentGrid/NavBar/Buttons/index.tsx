  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="#403F4C"
      />
      <AllIcon width="20" height="20" color={textColor} />
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="#0083FF"
      />
      <BlogpostIcon width="20px" height="20px" color={textColor} />
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="#4801EC"
      />
      <PodcastIcon width="20px" height="20px" color={textColor} />
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="#F36312"
      />
      <CaseStudiesIcon width="20px" height="20px" color={textColor} />
      <text x="115px" y="27px" className={styles.buttonText} fill={textColor}>
        Case Studies
      </text>
    </svg>
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="#9563FF"
      />
      <TalksIcon width="20px" height="20px" color={textColor} />
